  ...
  <div class="modal-overlay" @click="store.closeModal()">
    <div class="modal-content dark:bg-gray-800" @click.stop>
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-semibold dark:text-white">Adicionar Aluno</h2>
      ...
      <form @submit.prevent="handleSubmit">
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nome do Aluno</label>
            <input 
              v-model="form.name"
              type="text" 
              required
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nome do Responsável</label>
            <input 
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">WhatsApp do Responsável</label>
            <input 
