...
.product-actions {
  @apply flex justify-center items-center gap-2 p-3;
}
...
.delete-button {
  @apply p-2 bg-red-100 text-red-600 rounded-lg hover:bg-red-200 transition-colors dark:bg-red-900 dark:text-red-400 dark:hover:bg-red-800;
}
